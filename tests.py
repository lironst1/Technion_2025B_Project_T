...
from __cfg__ import logger, DataType, DATA_TYPES
...
def data_type_valid(data_type: str):
    ...
    if not DATA_TYPES[data_type].return_to_user:
        raise ValueError(f"Data type '{data_type}' is not intended for user access.")
